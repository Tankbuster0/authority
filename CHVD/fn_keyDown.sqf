...
_vdString = "";
for "_i" from 1 to (CHVD_maxView / 500) do {
	if (((call compile _viewDistVar) / 500) < _i) then {
		_vdString = _vdString + "·";
	} else {	
...
_ovdString = "";
for "_i" from 1 to (CHVD_maxObj / 500) do {
	if (((call compile _objViewDistVar / 500)) < _i) then {
...
hintSilent parseText format ["<t align='left'>
%2:	%3
<br /> 
