...
testmode = false;
if ((serverName in ["Tanky-Test", "Tanky test", "TankyTest"]) or (isServer and hasInterface) or ("PARAM_testmode" call BIS_fnc_getParamValue) isEqualTo 1) then {testmode = true;};
