...
//[parseText "<t font='PuristaBold' size='1.6'>Congratulations, you've driven the enemy from the AO.</t>", true, nil, 7, 0.7, 0] spawn BIS_fnc_textTiles;
[parseText "<t font='PuristaBold' size='1.6'>Congratulations, you've driven the enemy from the AO.</t>", true, 10, 7, 0.7, 0] remoteExecCall ["BIS_fnc_textTiles",0 false];
sleep 10;
