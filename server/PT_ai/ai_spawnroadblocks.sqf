	...
	_campgroup = createGroup east;
{
	...
	diag_log format ["***aisrb makes roadblock number %1 of %4 at %2 which is %3 from primary target", _foreachindex, _pos, floor (_pos distance2D cpt_position), (count _myroadarray1) -1];
	_gate setDir _dir;
