...
//_wp2 setWaypointScript "server\PT_ai\ai_reinforcementsattack.sqf";
_wp2 setWaypointStatements [ "true", "_nul = this execVM 'server\PT_ai\ai_reinforcementsattack.sqf'"];
