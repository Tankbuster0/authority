...
heartandmindscore = (_ruinendcount - _ruinstartcount) + civkillcount + reinforcementcounter;// plus a point if captive opfor are killed
...
sleep 10;
_handle2 = [] execVM "server\sm_manager";
