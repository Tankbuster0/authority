...
switch (true) do
	{
		...
		case _obj isKindOf "Scooter_Transport_01_base_F":
			{
				_texturelist = getArray (configFile/"CfgVehicles"/typeOf _obj/"texturelist");
				_texturelist = _texturelist select {typeName _x isEqualTo "STRING"};// array also contains numbers, remove them
				{
