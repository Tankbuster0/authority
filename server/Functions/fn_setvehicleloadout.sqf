...
switch (typeof _vec) do
	...
	case forwardpointvehicleclassname:
		...
		_vec addMagazineCargoGlobal ["10Rnd_50BW_Mag_F", 20];
		_vec addMagazineCargoGlobal ["Rnd_65x39_caseless_mag_Tracer",20];
