...
[
	...
	["Land_DataTerminal_01_F", [8, -4 ,0], 0,1,0, [0,0], "fobdataterminal", "prizerecovfrombuildfobid = fobdataterminal addaction ['Recover prize vehicles from Airhead (buildfob version)', 'client\recoverprize.sqf', '',0,true,true, '', '', 'islandhop', true, false]", true,false],
...
/*if (isDedicated) then
{
	[fobdataterminal, ["Greetings!", {hint "Hello!"}]] remoteExec ["addAction", -2, _obj];
};*/
