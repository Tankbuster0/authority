...
[
	...
	["Land_DataTerminal_01_F", [8, -4 ,0], 0,1,0, [0,0], "fobdataterminal", "_this addaction ['Recover prize vehicles from Airhead (buildfob version)', 'client\recoverprize.sqf', '',0,true,true]", true,false],
...
if (isDedicated) then
{
	[fobdataterminal, ["Recover prize vehicles from Airhead (buildfob version)", {_nul = execVM "client\recoverprize.sqf"}]] remoteExec ["addAction", -2, fobdataterminal];
};
