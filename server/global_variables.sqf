...
opfor_planes = ["O_Plane_CAS_02_F", "I_Plane_Fighter_04_F","O_Plane_Fighter_02_Stealth_F", "O_T_VTOL_02_infantry_F", "I_Plane_Fighter_03_CAS_F","I_Plane_Fighter_04_F","C_Plane_Civil_01_racing_F" ];
opfor_helis = ["O_Heli_Light_02_F", "O_Heli_Light_02_v2_F","O_Heli_Attack_02_F", "O_Heli_Attack_02_black_F", "O_Heli_Transport_04_covered_F", "I_Heli_Transport_02_F", "I_Heli_light_03_F","  	C_Heli_Light_01_civil_F"];
