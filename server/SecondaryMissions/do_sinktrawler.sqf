...
_smnrlogs = (_missionpos nearEntities ["Logic", 10000]) select {(((_x getVariable ["targetstatus", -1]) isEqualTo 1) and ((_x distance2d cpt_position) > 2000)) };
...
smship2 = createVehicle ["C_Boat_Civil_04_F",_ship2pos , random 360]),[],0,"NONE"];
