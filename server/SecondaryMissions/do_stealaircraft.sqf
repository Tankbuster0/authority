...
diag_log format ["***dsa makes a mission at %1", (_smairfield getVariable "targetname")];
 format ["Satellite intel reports  there's an enemy aircraft at %1 that our R and D guys would quite like to see. Steal it and bring it back to our airbase.", _smairfield getVariable "targetname"] remoteexecCall ["tky_fnc_usefirstemptyinhintqueue",2,false];
