...
flipactionid = player addAction ["Flip Vehicle", "client\unflipvehicle.sqf", "", 0, false, true, "", " ( (player getUnitTrait 'engineer') or ( count (player nearentities [['B_APC_Tracked_01_CRV_F', 'B_Truck_01_Repair_F', 'Offroad_01_repair_base_F', 'O_Truck_03_repair_F'],7]) > 0 ) ) and { (cursorObject isKindOf 'LandVehicle' and (((vectorup cursorObject) select 2) < 0.5) and (!(canmove cursorObject)) and ((player distance2D cursorObject) < 6) ) } " ];
__tky_ends