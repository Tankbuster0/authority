...
while {(!isNull _inventoryDisplay)} do
{
	...
	{
		_uniformLoadText ctrlSetStructuredText parseText format ["<t size='0.6' align='center' color='#FFFF00'>%1 / %2</t>", (loadUniform player), (getContainerMaxLoad uniform player)];
	} else
	{
	...
	if ((vest player != "")) then
	{
		_vestLoadText ctrlSetStructuredText parseText format ["<t size='0.6' align='center' color='#FFFF00'>%1 / %2</t>", (loadVest player), (getContainerMaxLoad vest player)];
	} else
	{
	...
	{
		_backpackLoadText ctrlSetStructuredText parseText format ["<t size='0.6' align='center' color='#FFFF00'>%1 / %2</t>", (loadBackpack player), (getContainerMaxLoad backpack player)];
	} else
	{
