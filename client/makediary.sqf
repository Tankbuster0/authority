...
player createDiaryRecord ["yourstuff", ["Deploying the FOB", "Drive the FOB vehicle into a wideopen and flat enough space and you can deploy the FOB. When it deploys, a small number of assets are made close by; another ammocache, a spawn point and a medic tent. <br />The player who deploys it has access to the Zeus interface and can make a few other assets such as static weapons, sandbags and another helipad which can service your vehicles and aircraft."]];
